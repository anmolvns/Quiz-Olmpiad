...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String username) {
        ...
        Image i2 = i1.getImage().getScaledInstance(1200, 350, Image.SCALE_DEFAULT);
        ...
        qno.setBounds(20, 400, 60, 30);
        add(qno);

        question = new JLabel("");
        question.setFont(new Font("Tahoma", Font.PLAIN, 24));
        question.setBounds(60, 400, 900, 30);
        add(question);
        

        q[0][0] = "Who invented Java Programming?";
        q[0][1] = "James Gosling";
        q[0][2] = "Guido van Rossum";
        q[0][3] = "Dennis Ritchie";
        q[0][4] = "Bjarne Stroustrup";

        q[1][0] = "Which one of the following is not a Java feature?";
        q[1][1] = "Object-oriented";
        q[1][2] = "Use of pointers";
        q[1][3] = "Portable";
        q[1][4] = "Dynamic and Extensible";
        ...
        q[3][0] = "Which of these cannot be used for a variable name in Java?";
        q[3][1] = "Identifier & keyword";
        q[3][2] = "Identifier";
        q[3][3] = "keyword";
        q[3][4] = "none of the mentioned";

        q[4][0] = "What is the extension of compiled java classes?";
        q[4][1] = ".txt";
        q[4][2] = ".js";
        q[4][3] = ".java";
        q[4][4] = ".class";
        ...
        q[7][1] = "Java Archive Resource";
        q[7][2] = "Java Archive Runner";
        ...
        q[9][0] = "Which is used to find and fix bugs in the Java programs.?";
        q[9][1] = "JDB";
        q[9][2] = "JRE";
        q[9][3] = "JDK";
        q[9][4] = "JVM";
        ...
        qa[6][1] = "import";
        qa[7][1] = "Java Archive Runner";
        qa[8][1] = "java.lang.StringBuilder";
        qa[9][1] = "JDB";

        opt1 = new JRadioButton("");
        opt1.setBounds(90, 450, 700, 30);
        opt1.setFont(new Font("Dialog", Font.PLAIN, 20));
        opt1.setBackground(Color.WHITE);
        add(opt1);

        opt2 = new JRadioButton("");
        opt2.setBounds(90, 490, 700, 30);
        opt2.setFont(new Font("Dialog", Font.PLAIN, 20));
        opt2.setBackground(Color.WHITE);
        add(opt2);

        opt3 = new JRadioButton("");
        opt3.setBounds(90, 530, 700, 30);
        opt3.setFont(new Font("Dialog", Font.PLAIN, 20));
        opt3.setBackground(Color.WHITE);
        add(opt3);

        opt4 = new JRadioButton("");
        opt4.setBounds(90, 570, 700, 30);
        ...
        lifeline.setBounds(900, 510, 170, 40);
